...
TARGET_URL = "https://musiccrawler.live/"
        ...
        for step in range(max_steps):
            ...
            messages = [{
                ...
                "content": [
                    ...
                    {
                        "type": "text",
                        "text": f"""You are submitting a concert listing on musiccrawler.live.
...
Respond with ONLY one action line, nothing else."""
            ...
            if action.startswith("DONE"):
                url = action.replace("DONE", "").strip() or f"{TARGET_URL}events"
                browser.close()
